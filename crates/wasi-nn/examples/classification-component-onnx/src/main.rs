...
use image::{io::Reader, DynamicImage, RgbImage};
use ndarray::{Array, Dim};

const IMG_PATH: &str = "fixture/images/dog.jpg";

use bindings::wasi::nn::{
...
fn main() -> Result<(), ()> {
    ...
    let output_tensor = exec_context
...
// Take the image located at 'path', open it, resize it to height x width, and
// then converts the pixel precision to FP32. The resulting BGR pixel vector is
// then returned.
