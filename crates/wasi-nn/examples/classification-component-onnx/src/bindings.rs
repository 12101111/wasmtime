...
pub mod wasi {
    pub mod nn {
        ...
        pub mod tensor {
            ...
            ///
            /// The array length matches the tensor rank and each element in the
            /// array describes the size of each dimension
            ...
            /// The tensor data.
            ///
            /// Initially conceived as a sparse representation, each empty cell
            /// would be filled with zeros and the array length must
            /// match the product of all of the dimensions and the number of
            /// bytes in the type (e.g., a 2x2 tensor with 4-byte
            /// f32 elements would have a data array of length
            /// 16). Naturally, this representation requires some knowledge of
            /// how to lay out data in memory--e.g., using row-major
            /// ordering--and could perhaps be improved.
            ...
            impl Tensor {
                #[allow(unused_unsafe, clippy::all)]
                /// Describe the size of the tensor (e.g., 2x2x2x2 -> [2, 2, 2,
                /// 2]). To represent a tensor containing a
                /// single value, use `[1]` for the tensor dimensions.
        ...
        pub mod errors {
            ...
            pub enum ErrorCode {
                ...
                /// Graph not found.
                NotFound,
                /// The operation is insecure or has insufficient privilege to
                /// be performed. e.g., cannot access a hardware
                /// feature requested
                Security,
            ...
            impl Error {
                #[allow(unused_unsafe, clippy::all)]
                /// Errors can propagated with backend specific status through a
                /// string value.
        ...
        pub mod inference {
            ...
            impl GraphExecutionContext {
                ...
                ///
                /// Note the expected sequence of calls: `set-input`, `compute`,
                /// `get-output`. TODO: this expectation could
                /// be removed as a part of https://github.com/WebAssembly/wasi-nn/issues/43.
        ...
        pub mod graph {
            ...
            /// Describes the encoding of the graph. This allows the API to be
            /// implemented by various backends that encode (i.e.,
            /// serialize) their graph IR with different formats.
            #[repr(u8)]
            #[derive(Clone, Copy, Eq, PartialEq)]
            ...
            ///
            /// This gets bundled up into an array of buffers because
            /// implementing backends may encode their graph IR in
            ...
            #[allow(unused_unsafe, clippy::all)]
            /// Load a `graph` from an opaque sequence of bytes to use for
            /// inference.
            pub fn load(
            ...
            ///
            /// How the host expects the names to be passed and how it stores
            /// the graphs for retrieval via this function is
            /// **implementation-specific**. This allows hosts to choose name
            /// schemes that range from simple to complex (e.g.,
            /// URLs?) and caching mechanisms of various kinds.
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.21.0:classify:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1516] = *b"\
...
\x01\x01m\x06\x08openvino\x04onnx\x0atensorflow\x07pytorch\x0etensorflowlite\x0a\
autodetect\x04\0\x0egraph-encoding\x03\0\x07\x01m\x03\x03cpu\x03gpu\x03tpu\x04\0\
\x10execution-target\x03\0\x09\x01p}\x04\0\x0dgraph-builder\x03\0\x0b\x01h\x06\x01\
i\x05\x01i\x01\x01j\x01\x0e\x01\x0f\x01@\x01\x04self\x0d\0\x10\x04\0$[method]gra\
ph.init-execution-context\x01\x11\x01p\x0c\x01i\x06\x01j\x01\x13\x01\x0f\x01@\x03\
\x07builder\x12\x08encoding\x08\x06target\x0a\0\x14\x04\0\x04load\x01\x15\x01@\x01\
\x04names\0\x14\x04\0\x0cload-by-name\x01\x16\x03\x01\x0dwasi:nn/graph\x05\x07\x04\
\x01\x20example:onnx-classifier/classify\x04\0\x0b\x0e\x01\0\x08classify\x03\0\0\
